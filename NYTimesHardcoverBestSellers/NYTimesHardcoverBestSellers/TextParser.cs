...
namespace NYTimesHardcoverBestSellers
{
    ...
    public static class TextParser
    {
        ...
        private const string DataPattern = @"(\d+) ([-\dF]+) ([\d]+)";
        private const string TitlePattern = @"([\w\s,.':\-’&""]+) \([\w\s,.':\-’&""]+\)";
        ...
        public static Entry ParseEntry(string data, string title)
        {
            ...
            match3Text = match3Text.EndsWith("F") ? match3Text.Remove(match3Text.Length - 1) : match3Text;
            ...
            var titleString = titleMatch.Groups[1].Value;
